...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(brain.config.endpoints);

    var serviceConfig = $.extend(true, {}, brain.config.services, {
        db: {
    ...
    brain.db = new DevExpress.data.ODataContext(serviceConfig.db);
