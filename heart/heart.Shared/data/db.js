...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(heart.config.endpoints);

    var serviceConfig = $.extend(true, {}, heart.config.services, {
        db: {
    ...
    heart.db = new DevExpress.data.ODataContext(serviceConfig.db);
