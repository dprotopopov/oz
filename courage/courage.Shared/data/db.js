...
(function() {
    var endpointSelector = new DevExpress.EndpointSelector(courage.config.endpoints);

    var serviceConfig = $.extend(true, {}, courage.config.services, {
        db: {
    ...
    courage.db = new DevExpress.data.ODataContext(serviceConfig.db);
